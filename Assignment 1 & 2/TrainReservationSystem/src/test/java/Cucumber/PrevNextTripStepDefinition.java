...
public class PrevNextTripStepDefinition {
    ...
    public void train_has_more_that_three_trips_and_has_a_previous_and_next_trip() throws TripException {
        ...
        Instant departureTime1 = Instant.parse("2023-12-10T10:00:00Z");
        Instant arrivalTime1 = Instant.parse("2023-12-15T14:00:00Z");
        trip1 = trs.createTrip(origin1, destination1, train, departureTime1, arrivalTime1);

        City destination2 = new CityImpl("City D");
        Instant departureTime2 = Instant.parse("2023-12-16T10:00:00Z");
        Instant arrivalTime2 = Instant.parse("2023-12-25T14:00:00Z");
        trip2 = trs.createTrip(destination1, destination2, train, departureTime2, arrivalTime2);

        City destination3 = new CityImpl("City F");
        Instant departureTime3 = Instant.parse("2023-12-27T10:00:00Z");
        Instant arrivalTime3 = Instant.parse("2023-12-29T14:00:00Z");
        trip3 = trs.createTrip(destination2, destination3, train, departureTime3, arrivalTime3);
    }
